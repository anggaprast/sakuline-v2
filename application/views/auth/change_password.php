...
<head>
  ...
  <title>Ubah Password | Sakuline</title>
  <!-- Favicon -->
    ...
    <div class="container">
      ...
      <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
        ...
        <ul class="navbar-nav align-items-lg-center ml-lg-auto">
          <li class="nav-item">
            <a class="nav-link nav-link-icon" href="https://www.facebook.com/Kawula Muda Jembangan" target="_blank" data-toggle="tooltip" data-original-title="Like us on Facebook">
              <i class="fab fa-facebook-square"></i>
              <span class="nav-link-inner--text d-lg-none">Facebook</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link nav-link-icon" href="https://www.instagram.com/kawulamuda_jembangan" target="_blank" data-toggle="tooltip" data-original-title="Follow us on Instagram">
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-8 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Website Katalog Buku Perpustakaan Daerah Kabupaten Banjarnegara</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-body px-lg- py-lg-5">
              <div class="text-center mb-4">
                <h1 class="text-blue">Ubah password</h1>
                <h4 class="text-blue"><?= $this->session->userdata('reset_email');?></h4>
              </div>
              ...
              <form role="form" method="post" action="<?= base_url('auth/changePassword');?>">
                <div class="form-group mb-3">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" id="password" name="password" placeholder="Passwor Baru" type="password">
                  </div>
                  <?= form_error('password', '<small class="text-danger pl-3">', '</small>');?>
                </div>
                <div class="text-center">
                  <button type="submit" name="login" class="btn btn-block btn-primary my-4">Ubah Password</button>
                </div>
              </form>
            </div>
          </div>
