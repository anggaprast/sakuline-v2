...
<head>
  ...
  <title>Lupa Password | Sakuline</title>
  <!-- Favicon -->
          ...
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-body px-lg- py-lg-5">
              <div class="text-center mb-4">
                <h1 class="text-blue">Lupa Password?</h1>
              </div>
              ...
              <form role="form" method="post" action="<?= base_url('auth/forgotPassword');?>">
                ...
                <div class="text-center">
                  <button type="submit" name="login" class="btn btn-block btn-primary my-4">Reset Password</button>
                </div>
              </form>
              <div class="text-center">
                <a href="<?= base_url('auth');?>" class="text-blue"><small>Kembali ke Login</small></a>
              </div>
            </div>
          </div>
        </div>
